...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/arow_top.svg
  SvgGenImage get arowTop => const SvgGenImage('assets/icons/arow_top.svg');

  /// File path: assets/icons/arrow_botom.svg
  SvgGenImage get arrowBotom =>
      const SvgGenImage('assets/icons/arrow_botom.svg');
  ...
  /// File path: assets/icons/emoji_happy.svg
  SvgGenImage get emojiHappy =>
      const SvgGenImage('assets/icons/emoji_happy.svg');

  /// File path: assets/icons/star.svg
  SvgGenImage get star => const SvgGenImage('assets/icons/star.svg');

  /// File path: assets/icons/tick_quare.svg
  SvgGenImage get tickQuare => const SvgGenImage('assets/icons/tick_quare.svg');
